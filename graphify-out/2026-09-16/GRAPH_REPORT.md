...
## Communities (315 total, 93 thin omitted)

### Community 0 - "HubReceptionService"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (5): Dashboard, IncidentsManager, Incidents, Incidents, Incident

### Community 9 - "web.php"
Cohesion: 0.06
Nodes (11): HelpCenter, RoutesDashboard, Dashboard, HelpCenter, Packages, PendingPayments, AppDownload, PackageDetail (+3 more)
...
Cohesion: 0.09
Nodes (5): Warehouse, WarehouseCoverage, WarehouseCoverageManagerTest, HubReceptionServiceTest, LogisticsResolutionServiceTest
...
### Community 92 - "User"
Cohesion: 0.06
Nodes (6): User, AllyFinancialSettlementTest, AuthenticationTest, PasswordConfirmationTest, PasswordResetTest, ProfileTest
...
Cohesion: 0.09
Nodes (4): PackageCreate, Customer, ClientDashboardTest, ClientPendingPaymentsTest

### Community 98 - "Livewire\Component"
Cohesion: 0.09
Nodes (16): DailyCashCut, HelpCenter, ExportsSpreadsheet, HelpCenter, Illuminate\Database\Eloquent\Builder, Illuminate\Support\Carbon, Illuminate\Support\Facades\Auth, Illuminate\Validation\Rule (+8 more)
...
Cohesion: 0.05
Nodes (10): DriverAssignment, PackageDispatch, PackageReception, Cod, PackageDetail, PackagePickup, PackageReception, PublicTracking (+2 more)
...
### Community 159 - ".route"
Cohesion: 0.05
Nodes (12): VerifyAccount, PackageStatusUpdated, MailMessage, MailMessage, WelcomeVerificationToken, Illuminate\Notifications\Messages\MailMessage, Illuminate\Notifications\Notification, AuditLogViewerTest (+4 more)
...
Cohesion: 0.08
Nodes (14): Illuminate\Database\Eloquent\ModelNotFoundException, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, Illuminate\Support\Facades\Http, Illuminate\Support\Facades\Queue, Livewire\Livewire, Maatwebsite\Excel\Facades\Excel, UsersManagerSearchUrlTest (+6 more)
...
Cohesion: 0.14
Nodes (6): DriversApprovalManager, Driver, DeliveryAssignmentServiceTest, DriverDashboardTest, DriverHubTransferApiTest, DriverRouteCompletePendingPackagesTest

### Community 199 - "api.php"
Cohesion: 0.23
Nodes (5): DriverDashboardController, VerifyEmailController, Illuminate\Foundation\Auth\EmailVerificationRequest, Illuminate\Http\RedirectResponse, Illuminate\Support\Facades\Route
...
Cohesion: 0.28
Nodes (4): Illuminate\Auth\Notifications\ResetPassword, Illuminate\Http\UploadedFile, Illuminate\Support\Facades\Notification, Livewire\Volt\Volt
...
Cohesion: 0.07
Nodes (11): CreatePackage, AuditLog, PackageHistory, DeliveryAssignmentService, DriverPaymentService, IncidentService, PackageService, Illuminate\Auth\Access\AuthorizationException (+3 more)

### Community 320 - "Illuminate\Http\JsonResponse"
Cohesion: 0.16
Nodes (8): DriverAuthController, DriverDeliveryController, Controller, DriverScanController, PaymentWebhookController, Illuminate\Http\JsonResponse, Illuminate\Support\Facades\Validator, Throwable
...
- **Why does `Package` connect `Package` to `HubReceptionService`, `Dashboard`, `PaymentOrder`, `PackageDetailCodPaymentMethodTest`, `Incident`, `web.php`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `StaffManager`, `PackageCreateRegisteredByTest`, `TrackingController`, `LoginForm.php`, `Ally`, `RuntimeException`, `SalesCloseout`, `Dashboard`, `PackageServiceCodTest`, `LogisticsResolutionService`, `Scanner`, `Warehouse`, `.route`, `TestCase`, `PackageLabelController.php`, `Illuminate\Http\JsonResponse`, `Driver`, `api.php`, `Route`, `Illuminate\Database\Eloquent\Relations\HasMany`, `DriverPackageResource`, `Illuminate\Http\Request`, `Customer`, `Livewire\Component`, `AllyFinancialService`, `DriverHubDistributionController.php`, `TariffService`, `Dashboard`, `BcvRate`, `PackageSecurityHashTest`, `GeocodePackageDeliveryAddress`, `PackageCreateDeliveryCoordinatesTest`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `PackageDetailCodPaymentMethodTest`, `DeliveryClaimFromDestinationAgencyTest`, `StaffManagerTest`, `RoutesManagerHubDistributionTest`, `RouteStop`, `UserAuthorizationTest`, `Incident`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Livewire\Volt\Volt`, `AllyUser`, `StaffManager`, `UsersManager`, `LoginForm.php`, `Ally`, `AllyFinanceTest`, `RuntimeException`, `DriverPayment`, `DriverApiFlowTest`, `Warehouse`, `PackageServiceCodTest`, `.route`, `DriverAssignmentRenderTest`, `AlliesManagerLocationTest`, `PackageReceptionHubTest`, `TestCase`, `DriverRouteClaimTest`, `WarehouseDispatchTest`, `Illuminate\Http\JsonResponse`, `Driver`, `AllyFinancialServiceTest`, `DriverHubDistributionTest`, `Illuminate\Database\Eloquent\Relations\HasMany`, `RoutesManagerListFilterTest`, `OfficeLocatorLocationTest`, `WarehousesManagerTest`, `EmailVerificationTest.php`, `Recommendation`, `DriverRouteReleaseTest`, `UsersManagerDriverTypeTest`, `Livewire\Component`, `Customer`, `DashboardClaimRouteTest`, `DriverHubReceptionTest`, `HubDashboardUxTest`, `DriverRouteCompleteTest`, `.homeRouteName`, `RoutesManagerMultistateTest`, `DriverRouteActiveHubScanTest`, `WarehouseStaffRoleTest`, `.ally`, `HubReleaseServiceTest`, `PackageReceptionScannerTest`, `ScannerHubOperationUxTest`, `AlliesManagerDestinationVerificationTest`, `DeliveryRouteOrderGeocodingTest`, `DatabaseSeeder.php`, `RoutesManagerStopFilterTest`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `Warehouse` connect `Warehouse` to `HubReceptionService`, `Dashboard`, `RouteStop`, `RoutesManagerHubDistributionTest`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Package`, `UsersManager`, `LoginForm.php`, `RuntimeException`, `.route`, `PackageReceptionHubTest`, `TestCase`, `WarehouseDispatchTest`, `Driver`, `DriverHubDistributionTest`, `Illuminate\Database\Eloquent\Relations\HasMany`, `WarehousesManagerTest`, `WarehousesManager`, `Livewire\Component`, `HubDashboardUxTest`, `RoutesManagerMultistateTest`, `DriverRouteActiveHubScanTest`, `WarehouseStaffRoleTest`, `HubReleaseServiceTest`, `ScannerHubOperationUxTest`, `RoutesManagerStopFilterTest`?**

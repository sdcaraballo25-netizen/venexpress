...
Cohesion: 0.07
Nodes (10): TrackingController, IncidentsManager, Incidents, Incident, IncidentService, AppLayout, GuestLayout, Illuminate\Auth\Access\AuthorizationException (+2 more)

### Community 9 - "PaymentOrder"
Cohesion: 0.10
Nodes (6): PaymentWebhookController, PaymentOrders, PaymentOrder, PaymentReconciliationService, Illuminate\Contracts\View\View, Illuminate\Support\Facades\Validator
...
### Community 17 - "Ally"
Cohesion: 0.08
Nodes (4): AlliesManager, OfficeLocator, Ally, Illuminate\Database\Eloquent\Relations\HasMany
...
Cohesion: 0.13
Nodes (5): FieldScanner, Scanner, HubDistributionPhase, LogisticsScanService, PackageDispatchService
...
### Community 92 - "User"
Cohesion: 0.07
Nodes (5): User, DriverFactory, PasswordConfirmationTest, ProfileTest, UserAuthorizationTest
...
Cohesion: 0.11
Nodes (13): AuditLogViewer, Dashboard, DriverRemunerationManager, RoutesDashboard, Incidents, Illuminate\Support\Carbon, Illuminate\Support\Facades\Auth, Illuminate\Validation\Rule (+5 more)

### Community 100 - "static"
Cohesion: 0.15
Nodes (5): self, self, self, self, static

### Community 102 - "BcvRateService"
Cohesion: 0.16
Nodes (5): CheckProductionReadiness, SyncBcvRate, BcvRateService, Carbon\Carbon, Illuminate\Console\Command
...
Cohesion: 0.10
Nodes (5): AllySettlement, DriverRemunerationRate, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\BelongsTo
...
Cohesion: 0.08
Nodes (7): DailyCashCut, Dashboard, Packages, Dashboard, PendingPayments, Packages, RouteDetail
...
Cohesion: 0.06
Nodes (8): PackageDispatch, PackageReception, Cod, PackagePickup, PackageReception, PublicTracking, Package, DateTimeInterface
...
Cohesion: 0.08
Nodes (11): PackageDetail, PackageHistory, DeliveryAssignmentService, DestinationReceptionService, HubReceptionService, PackageService, Illuminate\Database\QueryException, Illuminate\Support\Facades\DB (+3 more)
...
- **Why does `Package` connect `Package` to `Commissions`, `Dashboard`, `AuditLog`, `Incident`, `PaymentOrder`, `RouteStop`, `PackageServiceCodTest`, `Ally`, `.str`, `PriceCalculator`, `DriverPayment`, `GeocodePackageDeliveryAddress`, `Driver`, `DriverAssignment`, `Route`, `RuntimeException`, `Scanner`, `User`, `Livewire\Component`, `PackageStatusUpdated`, `TariffService`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Http\Request`, `web.php`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `DashboardClaimRouteTest`, `AuditLog`, `Incident`, `Livewire\Volt\Volt`, `UsersManager`, `RouteStop`, `PackageServiceCodTest`, `Ally`, `UsersManagerDriverTypeTest`, `Warehouse`, `DriverApiFlowTest`, `PasswordResetTest.php`, `DriverHubDistributionTest`, `.update`, `ScannerLivewireTest`, `Driver`, `AllyFinancialServiceTest`, `.route`, `DriverRouteCompleteTest`, `HubDashboardUxTest`, `EmailVerificationTest.php`, `PackageCreate`, `Livewire\Component`, `LoginForm.php`, `AllyUser`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Http\Request`, `DriverRouteClaimTest`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `Route` connect `Route` to `DashboardClaimRouteTest`, `Dashboard`, `UsersManager`, `RouteStop`, `Warehouse`, `DriverApiFlowTest`, `DriverHubDistributionTest`, `ScannerLivewireTest`, `Driver`, `DriverAssignment`, `.route`, `DriverRouteCompleteTest`, `RuntimeException`, `Scanner`, `HubDashboardUxTest`, `Livewire\Component`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Http\Request`, `web.php`, `DriverRouteClaimTest`?**

    ...
    <section class="bg-white">
        <div class="max-w-3xl mx-auto px-6 py-14">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl md:text-4xl font-extrabold text-black">Preguntas frecuentes</h1>
            ...
            <div class="space-y-3">
                @foreach ($faqs as $index => $faq)
                    <div class="bg-gray-50 border border-gray-100 rounded-xl overflow-hidden">
                        ...
                        >
                            <span class="font-semibold text-black text-sm">{{ $faq['question'] }}</span>
            ...
            <div class="text-center mt-10">
                ...
                <a href="{{ route('public.recommendations') }}" class="inline-block mt-3 text-black font-semibold text-sm hover:underline">

    ...
    <section class="bg-white">
        <div class="max-w-2xl mx-auto px-6 py-14">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-3xl md:text-4xl font-extrabold text-blue-950">Envíanos tu recomendación</h1>
            ...
            @else
                <form wire:submit="submit" class="bg-gray-50 border border-gray-100 rounded-2xl p-6 space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-blue-950 mb-2">Nombre</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-blue-950 mb-2">Correo electrónico (opcional)</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-blue-950 mb-2">Tu recomendación</label>
                    ...
                    <button type="submit"
                        class="w-full bg-blue-950 hover:bg-blue-900 text-white font-semibold text-sm px-6 py-3 rounded-lg transition">

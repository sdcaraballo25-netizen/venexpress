...
<div class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-5">
    <h3 class="font-display text-lg font-semibold text-amber-900">Cobro en destino (COD)</h3>
    <p class="mt-1 text-sm text-amber-800">Monto: <strong>US$ {{ number_format((float) $package->cod_amount_usd, 2) }}</strong></p>
    <button wire:click="collectCod" class="mt-4 rounded-xl bg-amber-600 px-5 py-3 text-sm font-semibold text-white">Registrar cobro COD</button>
</div>
@endif

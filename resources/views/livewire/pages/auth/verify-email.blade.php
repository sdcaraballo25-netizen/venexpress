...
<div>
    ...
    <h1 class="font-display text-2xl font-bold text-black">Verifica tu correo</h1>
    ...
    <div class="mt-8 flex items-center justify-between gap-4">
        ...
        <button wire:click="logout" type="submit" class="text-sm font-medium text-gray-500 hover:text-black">
            Cerrar sesión
        </button>
    </div>
</div>

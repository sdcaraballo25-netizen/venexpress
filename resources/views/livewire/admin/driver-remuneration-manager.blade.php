<div class="min-h-screen">
    <div class="mb-8">
        <h1 class="font-display text-3xl font-bold text-[#111111]">Remuneración de Repartidores</h1>
        <p class="mt-1 text-sm text-[#6B6B66]">Define cuánto se paga a cada repartidor por cada paquete entregado. Es una tarifa global, aplica a todos por igual.</p>
    </div>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_360px]">
        ...
        <div class="overflow-hidden rounded-2xl border border-[#E5E5E0] bg-white shadow-sm">
            <div class="border-b border-[#E5E5E0] p-6">
                <h2 class="font-display text-lg font-bold text-[#111111]">Histórico de tarifas</h2>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="border-b border-[#E5E5E0] bg-slate-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-[#6B6B66]">Vigente desde</th>
                            <th class="px-6 py-4 text-right text-xs font-semibold uppercase text-[#6B6B66]">Monto (USD)</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-[#6B6B66]">Registrado por</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-10 text-center text-[#6B6B66]">
        ...
        <div class="h-fit rounded-2xl border border-[#E5E5E0] bg-white p-6 shadow-sm">
            ...
            <form wire:submit="save" class="space-y-4">
                <div>
                    <label class="mb-1 block text-xs font-bold uppercase tracking-wider text-[#6B6B66]">Monto por paquete entregado (USD)</label>

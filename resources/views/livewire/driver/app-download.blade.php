<div class="max-w-2xl mx-auto text-center py-6">
    ...
    <h1 class="text-3xl font-display font-extrabold text-[#0F172A]">Descarga la app de Venexpress</h1>
    <p class="text-[#64748B] mt-3 max-w-xl mx-auto">
    ...
    <div class="mt-10 bg-white border border-[#E2E8F0] rounded-2xl p-8 shadow-sm">
        @if ($apkAvailable)
            ...
            <p class="text-xs text-[#94A3B8] mt-4">
